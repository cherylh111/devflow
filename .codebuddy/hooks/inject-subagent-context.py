...
Context Source: DevFlow active task resolver points to task directory
...
AGENT_IMPLEMENT = "devflow-implement"
AGENT_CHECK = "devflow-check"
AGENT_RESEARCH = "devflow-research"
...
要获取结构化 package 信息，运行：`python ./{DIR_WORKFLOW}/scripts/get_context.py --mode packages`
