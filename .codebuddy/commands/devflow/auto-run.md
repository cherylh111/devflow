...
Run the trusted-team fast path: process ready DevFlow tasks one after another without asking the user to manually invoke `/devflow:continue` between phases.
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 2.1 --platform codebuddy
```
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 2.2 --platform codebuddy
python ./.devflow/scripts/get_context.py --mode phase --step 3.1 --platform codebuddy
```
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 3.3 --platform codebuddy
```
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 3.4 --platform codebuddy
```
...
Then follow `/devflow:finish-work`:
