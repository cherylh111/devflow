---
name: brainstorm
description: "Guide requirements discovery for a DevFlow task after task-creation consent. Use when the user is ready to clarify requirements before implementation."
---
