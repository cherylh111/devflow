...
- [OK] Auto-commits .devflow/workspace and .devflow/tasks changes
...
| Command | Purpose |
|---------|---------|
| `python3 ./.devflow/scripts/get_context.py --mode record` | Get context for record-session |
| `python3 ./.devflow/scripts/add_session.py --title "..." --commit "..."` | **One-click add session (recommended, branch auto-complete)** |
| `python3 ./.devflow/scripts/task.py archive <name>` | Archive completed task (auto-commits) |
| `python3 ./.devflow/scripts/task.py list` | List active tasks |
