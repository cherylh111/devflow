#!/usr/bin/env python3
"""
Common path utilities for DevFlow workflow.
...
def get_repo_root(start_path: Path | None = None) -> Path:
    """Find the nearest directory containing .devflow/ folder.
    ...
    Returns:
        Path to repository root, or current directory if no .devflow/ found.
    """
    ...
    # Fallback to current directory if no .devflow/ found
...
def normalize_task_ref(task_ref: str) -> str:
    ...
    `.devflow/tasks/03-27-my-task`, even on Windows. Absolute paths are preserved
...
def get_spec_dir(package: str | None = None, repo_root: Path | None = None) -> Path:
    ...
    Single-repo: .devflow/spec
    Monorepo with package: .devflow/spec/<package>
