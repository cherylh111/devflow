...
class CLIAdapter:
    ...
    def get_commands_path(self, project_root: Path, *parts: str) -> Path:
        ...
        Note:
            ...
            Windsurf uses workflow directory: .windsurf/workflows/devflow-<name>.md
    ...
    def get_devflow_command_path(self, name: str) -> str:
        ...
        Note:
            ...
            Windsurf: .windsurf/workflows/devflow-<name>.md
        ...
        if self.platform == "cursor":
            ...
            return f".windsurf/workflows/devflow-{name}.md"
        elif self.platform == "kilo":
