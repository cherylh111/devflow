---
description: "DevFlow Copilot 提示：第 3 部分：定制你的开发指南"
---
...
**The Solution**: The `.devflow/workspace/` system captures what happened in each session - what was done, what was learned, what problems were solved. The `/` command reads this history at session start, giving AI "artificial memory."
...
**The Solution**: The `.devflow/spec/` directory contains project-specific guidelines. The `/before-*-dev` commands inject this specialized knowledge into AI context before coding starts.
