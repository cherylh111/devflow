/**
 * Migration types for DevFlow update command
 *
 ...
 *
 * Used by `devflow update` to append the section to existing user config files
...
export interface ConfigSectionAdded {
  /** Target file relative to project root (e.g. `.devflow/config.yaml`). */
  file: string;
  /**
