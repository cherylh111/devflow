/**
 * `devflow channel rm <name>` — kill any live workers, then remove the
 * channel directory under `~/.devflow/channels/`.
 *
 * `devflow channel prune [--all | --idle <duration> | --empty]` — bulk
