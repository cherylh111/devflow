...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 2.1 --platform claude
```
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 2.2 --platform claude
python ./.devflow/scripts/get_context.py --mode phase --step 3.1 --platform claude
```
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 3.3 --platform claude
```
...
```bash
python ./.devflow/scripts/get_context.py --mode phase --step 3.4 --platform claude
```
