...
Follow the format of existing skill pages (see `docs-site/skills-market/devflow-meta.mdx` as reference):
...
```bash
npx skills add enpd/DevFlow/marketplace --skill <skill-name>
```

Or install all available skills:

```bash
npx skills add enpd/DevFlow/marketplace
```
