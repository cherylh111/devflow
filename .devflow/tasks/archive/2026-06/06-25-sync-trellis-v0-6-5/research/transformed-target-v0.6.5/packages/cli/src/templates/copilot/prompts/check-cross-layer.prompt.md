---
description: "DevFlow Copilot prompt: Cross-Layer Check"
---
...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.devflow/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](.devflow/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](.devflow/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
...
**Detailed Guide**: `.devflow/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.devflow/spec/guides/code-reuse-thinking-guide.md`
