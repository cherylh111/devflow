...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .devflow/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .devflow)
    if "/" in normalized or normalized.startswith(".devflow"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.devflow/tasks/test'): {is_safe_task_path('.devflow/tasks/test', repo)}")
