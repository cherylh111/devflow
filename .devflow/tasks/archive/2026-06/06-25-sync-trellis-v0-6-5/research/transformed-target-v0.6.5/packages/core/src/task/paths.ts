 ...
 * `.devflow/scripts/common/task_store.py::cmd_create`:
 *
 *     <tasks-dir>/05-13-devflow-core-sdk-package/
 *
 * DevFlow also creates system onboarding tasks during `devflow init` using a
...
export interface TaskDirParts {
  /**
   * The directory prefix. Dated tasks use `MM-DD`; DevFlow system onboarding
   * tasks use `00`.
   */
  prefix: string;
