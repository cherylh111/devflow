 ...
 *
 * Canonical source: `@enpd/devflow-core/channel`. This module is
...
import { buildContextEntries } from "@enpd/devflow-core/channel";
import type { ContextEntry } from "@enpd/devflow-core/channel";
