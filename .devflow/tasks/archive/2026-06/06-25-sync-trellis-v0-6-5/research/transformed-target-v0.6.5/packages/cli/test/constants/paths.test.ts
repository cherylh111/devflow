...
describe("DIR_NAMES", () => {
  ...
  it("WORKFLOW is .devflow", () => {
    expect(DIR_NAMES.WORKFLOW).toBe(".devflow");
  });
...
describe("getWorkspaceDir", () => {
  it("returns correct path for developer name", () => {
    expect(getWorkspaceDir("john")).toBe(".devflow/workspace/john");
  });

  it("handles hyphenated names", () => {
    expect(getWorkspaceDir("john-doe")).toBe(".devflow/workspace/john-doe");
  });

  it("handles empty string", () => {
    expect(getWorkspaceDir("")).toBe(".devflow/workspace/");
  });
});
...
describe("getTaskDir", () => {
  it("returns correct path for task name", () => {
    expect(getTaskDir("01-21-my-task")).toBe(".devflow/tasks/01-21-my-task");
  });

  it("handles nested-looking names", () => {
    expect(getTaskDir("sub/task")).toBe(".devflow/tasks/sub/task");
  });

  it("handles empty string", () => {
    expect(getTaskDir("")).toBe(".devflow/tasks/");
  });
});
...
describe("getArchiveDir", () => {
  it("returns correct archive path", () => {
    expect(getArchiveDir()).toBe(".devflow/tasks/archive");
  });
