...
describe("detectProjectType", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "devflow-detect-"));
  });
...
describe("detectMonorepo", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "devflow-monorepo-"));
  });
  ...
  it("merges pnpm workspace + .gitmodules and marks submodule", () => {
    ...
    mkPkg("packages/cli", "@devflow/cli");
    mkPkg("docs-site", "docs-site");
...
describe("detectMonorepo polyrepo fallback", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "devflow-poly-"));
  });
