...
|------|--------|----------|
| `.devflow/spec/mobile/index.md` | Create | Yes |
| `.devflow/spec/mobile/*.md` | Create | Yes |
| Task JSONL templates | Update | Yes |
| `devflow-local/SKILL.md` | Update | Yes |
...
Create `.devflow/spec/mobile/index.md`:
...
def init_mobile_context(task_dir):
    ...
    with open(jsonl_path, "a") as f:
        f.write(json.dumps({
            "file": ".devflow/spec/mobile/index.md",
...
```jsonl
{"file": ".devflow/spec/mobile/index.md", "reason": "Mobile guidelines"}
{"file": ".devflow/spec/mobile/architecture.md", "reason": "Architecture patterns"}
```

---

## Step 5: Document in devflow-local
