---
name: contribute
description: "Guide for contributing to DevFlow documentation and marketplace. Covers adding spec templates, marketplace skills, documentation pages, and submitting PRs across both the DevFlow main repo and docs repo. Use when someone wants to add a new spec template, add a new skill to the marketplace, add or update documentation pages, or submit a PR to this project."
---
...
| Skills + Spec templates | [enpd/DevFlow](https://github.com/enpd/DevFlow) | `marketplace/` directory |
...
## DevFlow Main Repo Marketplace Structure
            ...
            "pages": [
              {
                "group": "Skills",
                "expanded": false,
                "pages": ["skills-market/index", "skills-market/devflow-meta"]
              },
              {
...
Spec templates live in the **DevFlow main repo** at `marketplace/specs/`.
...
Add your template to `marketplace/index.json` in the DevFlow repo:
...
Skills live in the **DevFlow main repo** at `marketplace/skills/`.
...
Add your skill to `marketplace/index.json` in the DevFlow repo:
...
```bash
npx skills add enpd/DevFlow/marketplace -s your-skill
```
...
**For skills/spec templates** (DevFlow repo):

1. Fork: `https://github.com/enpd/DevFlow`
2. Clone: `git clone https://github.com/YOUR_USERNAME/DevFlow.git`
