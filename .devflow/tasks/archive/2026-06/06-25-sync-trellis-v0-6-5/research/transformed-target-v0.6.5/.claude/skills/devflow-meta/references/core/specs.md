...
```jsonl
{"file": ".devflow/spec/cli/frontend/index.md", "reason": "Frontend overview"}
{"file": ".devflow/spec/cli/frontend/component-guidelines.md", "reason": "Component patterns"}
```
...
```
1. Read .devflow/spec/{category}/index.md
...
```bash
touch .devflow/spec/cli/frontend/new-pattern.md
```
...
```bash
mkdir .devflow/spec/mobile
```

### 2. Create Index

```bash
touch .devflow/spec/mobile/index.md
```
