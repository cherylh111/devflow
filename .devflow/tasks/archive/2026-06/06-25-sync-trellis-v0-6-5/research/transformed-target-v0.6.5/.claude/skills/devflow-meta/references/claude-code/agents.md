...
Documentation for the DevFlow agent system - specialized AI agents for different development phases.

---

## Overview

DevFlow uses **specialized agents** for different tasks. Each agent has specific capabilities, restrictions, and context injection.
...
inject-subagent-context.py runs
            ...
            │   {"file": ".devflow/spec/cli/backend/index.md", "reason": "..."}
...
### Task Workflow (from /devflow:start)
...
```jsonl
{"file": ".devflow/spec/my-spec.md", "reason": "My agent spec"}
```
