...
Add a new `/devflow:my-command` command.
...
|------|--------|----------|
| `.claude/commands/devflow/my-command.md` | Create | Yes |
...
Create `.claude/commands/devflow/my-command.md`:
...
**Note**: Cursor commands don't have the `devflow:` prefix.

---

## Step 3: Document in devflow-local
...
1. Run the command: `/devflow:my-command`
