...
Usage (called automatically by task.py hooks):
    python .devflow/scripts/hooks/linear_sync.py create
    python .devflow/scripts/hooks/linear_sync.py start
    python .devflow/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.devflow/tasks/<name>/task.json python .devflow/scripts/hooks/linear_sync.py sync
