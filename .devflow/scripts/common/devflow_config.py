#!/usr/bin/env python3
"""
Standalone reader for .devflow/config.yaml.
...
CONFIG_REL_PATH = ".devflow/config.yaml"
...
def read_devflow_config(repo_root: Optional[Path] = None) -> dict:
    """Read .devflow/config.yaml. Returns {} on missing or malformed file."""
