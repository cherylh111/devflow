...
| [Script Conventions](./script-conventions.md) | Python script standards for .devflow/scripts/ | Done |
...
| [DevFlow Core SDK](./devflow-core-sdk.md) | `@enpd/devflow-core` / CLI package boundary, public exports, build and versioning contracts | Done |
...
| [Built-In Skill Authoring](./skill-authoring.md) | Common/bundled skill structure, trigger descriptions, localization parity, and validation rules | Done |
---
...
- Editing `packages/core/**`, moving reusable CLI logic into core, or changing CLI imports from `@enpd/devflow-core` → [devflow-core-sdk.md](./devflow-core-sdk.md)
...
- Adding or changing common workflow skills, bundled skills, localized skill overlays, or `.agents/skills/` dogfood copies → [skill-authoring.md](./skill-authoring.md)
