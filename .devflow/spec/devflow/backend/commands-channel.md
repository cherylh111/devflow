...
devflow channel create devflow-issue --scope global --type forum \
  ...
  --context-file /Users/me/work/DevFlow/.devflow/spec/devflow/backend/commands-channel.md
...
| Frontmatter prototype pollution | security | `.devflow/agents/x.md` with `__proto__: ...` frontmatter → key dropped, no pollution observable |
